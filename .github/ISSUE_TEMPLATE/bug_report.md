...
<!--
Thank you for reporting a possible bug in UCF-News-Plugin.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "UCF News Plugin" in the list of plugins. The version number will be listed under the plugin description.
-->
